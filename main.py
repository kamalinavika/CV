...
import sqlite3
import os
#mengimport module, package
#app adl variable untuk menyimpan package atau module
app = Flask(__name__)
app.secret_key = 'your_secret_key'  # Replace with a secret key for session management
#konfigurasi tempat penyimpanan file images
...
def index():
    ...
    conn.close()
    nama="Kamalina Vika S."
    hobbie = ["coding", "suka naik gunung", "fotografi"]
    return render_template('index.html', items=items, nama=nama, hobbie=hobbie)
